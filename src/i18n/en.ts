export default {
  ...
  gallery: {
    ...
    transformation: {
      title: "transformations in motion",
      items: [
        {
          title: "Stripped failed sealer on driveway",
        ...
        {
          title: "House wash including exterior window cleaning",
  ...
  footer: {
    description:
      "At Steve’s Premium Pressure Washing, we specialize in residential <br class='hidden lg:block'/> and commercial exterior cleaning. Proudly serving Orlando, Saint <br class='hidden lg:block'/> Cloud, Kissimmee, Winter Park, and Lake Nona.",
    service: {
      title: "SERVICE HOURS",
      items: [
        {
